...
const jsonLd = {
  ...
  name: "Moradia Leça do Balio",
  description:
    "Moradia de arquitetura de autor num loteamento fechado de vinte residências em Leça do Balio, Matosinhos. 2.545 m² de terreno, piscina aquecida.",
