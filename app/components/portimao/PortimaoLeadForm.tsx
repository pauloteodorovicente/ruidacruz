  ...
  return (
    <section id="contacto" className="bg-[#040815] text-[#f5f3ef] px-6 pt-16 pb-28 md:px-12 md:py-24">
      <Reveal className="mx-auto max-w-xl text-center block">
        <p className="text-xs tracking-[0.25em] uppercase text-[#5b7a9e] mb-3">{f.eyebrow}</p>
        ...
        {status === "success" ? (
          <div className="flex flex-col items-center gap-4 py-8">
            <span className="flex h-12 w-12 items-center justify-center rounded-full border border-[#5b7a9e]">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#5b7a9e" strokeWidth="2">
                <path d="M5 13l4 4L19 7" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </span>
            <p className="font-display text-xl text-[#5b7a9e]">Recebido. O Rui Da Cruz entrará em contacto em breve.</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="flex flex-col gap-4 text-left">
            <input
              ...
              required
              placeholder="Nome"
              className="bg-transparent border border-white/20 px-4 py-3 text-sm placeholder:text-white/40 focus:border-[#5b7a9e] outline-none transition-colors"
            />
            ...
            <textarea
              ...
              className="bg-transparent border border-white/20 px-4 py-3 text-sm placeholder:text-white/40 focus:border-[#5b7a9e] outline-none transition-colors resize-none"
            />
            ...
            <button
              ...
              className="mt-2 py-3.5 bg-[#5b7a9e] text-[#040815] font-body text-sm tracking-[0.05em] uppercase transition-all hover:bg-[#7a97b8] hover:-translate-y-0.5 focus-visible:outline-2 focus-visible:outline-[#5b7a9e] focus-visible:outline-offset-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0"
            >
