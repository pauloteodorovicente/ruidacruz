...
const MAP_URL = "https://www.google.com/maps/search/?api=1&query=Verdelago+Resort+Altura+Castro+Marim+Algarve";

export function VerdelagoLocation() {
  ...
  return (
    <section className="bg-background-raised px-6 py-14 md:px-12 md:py-20 border-y border-border">
      <Reveal className="mx-auto max-w-3xl block">
        ...
        <p className="font-body text-base md:text-lg text-foreground-muted leading-relaxed mb-6">{l.text}</p>
        <a
          href={MAP_URL}
          target="_blank"
