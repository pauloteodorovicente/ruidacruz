...
// o contorno é sempre branco, não segue as cores do tema claro/escuro (fica
// legível em cima de qualquer foto). Achado (24/08): quando marcado, o
// preenchimento também virava branco (currentColor herdado do contorno) —
// um coração branco preenchido em cima de foto clara ficava invisível. Agora
// o preenchimento vira um vermelho elegante, contorno branco continua igual.
const FAVORITE_FILL = "#c0394f";
    ...
    >
      <svg width="20" height="20" viewBox="0 0 24 24" strokeWidth="1.6" className="drop-shadow-[0_1px_2px_rgba(0,0,0,0.5)]">
        <path
          ...
          fill={isFavorite ? FAVORITE_FILL : "none"}
          stroke="currentColor"
        />
      </svg>
    </button>
