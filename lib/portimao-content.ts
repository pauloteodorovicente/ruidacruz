...
> = {
  "pt-PT": {
    ...
    nav: { sobre: "Sobre", contacto: "Contacto", guia: "Guia", faq: "FAQ", vender: "Vender" },
  ...
  en: {
    ...
    nav: { sobre: "About", contacto: "Contact", guia: "Guide", faq: "FAQ", vender: "Sell" },
  ...
  es: {
    ...
    breadcrumb: "Apartamento · Praia da Rocha, Portimão",
    nav: { sobre: "Acerca de", contacto: "Contacto", guia: "Guía", faq: "FAQ", vender: "Vender" },
  ...
  fr: {
    ...
    nav: { sobre: "À propos", contacto: "Contact", guia: "Guide", faq: "FAQ", vender: "Vendre" },
  ...
  it: {
    ...
    nav: { sobre: "Chi sono", contacto: "Contatti", guia: "Guida", faq: "FAQ", vender: "Vendere" },
  ...
  de: {
    ...
    nav: { sobre: "Über", contacto: "Kontakt", guia: "Leitfaden", faq: "FAQ", vender: "Verkaufen" },
